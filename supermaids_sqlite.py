...
# Print each table after tables been created
print("\n<<<========Tables Created========>>>")
...
cursor.execute('SELECT * FROM RequestEquipmentAssignment')
print("\n==========RequestEquipmentAssignment Table==========")
for row in cursor.fetchall():
    print(row)

cursor.execute('SELECT * FROM EmployeeRequestAssignment')
print("\n==========EmployeeRequestAssignment Table==========")
for row in cursor.fetchall():
    print(row)
...
# Print each table after tuples insertion
print("\n<<<=======Tables After tuple Insertion=======>>>")
